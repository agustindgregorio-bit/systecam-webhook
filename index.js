...
async function askCesy(phone, text) {
  ...
  return (data && (data.content || [data.me](https://data.me)ssage || data.response)) || "Hola! Soy Cesy de Systecam. En que puedo ayudarte?";
}
...
app.post("/webhook", async function(req, res) {
  ...
  try {
    ...
    const messages = body.entry && body.entry[0] && body.entry[0].changes && body.entry[0].changes[0] && body.entry[0].changes[0].value && body.entry[0].changes[0].[value.me](https://value.me)ssages;
    ...
    console.error("Error:", [err.me](https://err.me)ssage);
  }
});
